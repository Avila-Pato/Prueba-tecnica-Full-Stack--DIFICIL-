...
- Debes enviar tu solución como un **repositorio PRIVADO en GitHub** e invitar a **usuariodesconosido.com** como colaborador. También puedes intentarlo con el nombre de usuario **sp-tests**.
